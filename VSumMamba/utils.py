...
def save_model(model, args, best_fscore_k, epoch):
    if os.path.exists("/home/dym/STVT-main/STVT/STVT/model/"+args.dataset+"/model_" + str(args.roundtimes) + "_roundtimes"):
        shutil.rmtree("/home/dym/STVT-main/STVT/STVT/model/"+args.dataset+"/model_" + str(args.roundtimes) + "_roundtimes")
    if not os.path.exists("/home/dym/STVT-main/STVT/STVT/model/"+args.dataset+"/model_" + str(args.roundtimes)+"_roundtimes"):
        os.mkdir("/home/dym/STVT-main/STVT/STVT/model/"+args.dataset+"/model_" + str(args.roundtimes)+"_roundtimes")
    path = "/home/dym/STVT-main/STVT/STVT/model/"+args.dataset+"/model_"+str(args.roundtimes)+"_roundtimes/"+str(args.dataset)+"_"+str(epoch)+"_"+str(best_fscore_k)+".pth"
