...
def TVSum_77(args, distributed=False):
    class TVSum_77Dataset(Dataset):
        global In_target
        In_target = 0
            ...
            with h5py.File(file_dir, "r") as f:
                ...
                for key in f.keys():
                    ...
                    if video_number in video_amount:
                        print("start loading video:",video_number)
                        video = f[key]
                        ...
                        for ds_image_index in range(gonumber):
                            ...
                            try:
                                ...
                                cat_image = torch.FloatTensor(np.array(cat_image))
                            ...
                            f_image_number = [x for x in
                                              range(ds_image_index * patch_number + 1,
    ...
    file_dir = 'VSumMamba/dataloaders/datasets/TVSum_77.h5'
    video_amount = test_arr
    test_data = TVSum_77Dataset(file_dir=file_dir, video_amount=video_amount, F_In_target=False)
    ...
    train_data = TVSum_77Dataset(file_dir=file_dir, video_amount=video_amount, F_In_target=True)
